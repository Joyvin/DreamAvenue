										...
										{connectors.map((connector) => {
											return (
												<button
													...
													type="button"
													className="mb-2 me-2 text-black inline-flex items-center rounded-lg border border-2 border-black bg-white px-5 py-3 text-center text-lg text-sm font-medium text-gray-900 shadow-lg hover:bg-gray-100 focus:outline-none focus:ring-4 focus:ring-gray-100"
												>
													<img
														className="mr-2 h-8"
														src={
